...
import { IconSearch, IconCar, IconCircleCheckFilled, IconUsers, IconTools } from "@tabler/icons-react";

interface Props {
  search: string;
  setSearch: (value: string) => void;
  filterStatus: null | "available" | "borrowed" | "maintenance";
  setFilterStatus: (value: null | "available" | "borrowed" | "maintenance") => void;
}
...
export default function VehicleFilters({
  ...
  const handleFilter = useCallback(
    (status: null | "available" | "borrowed" | "maintenance") => setFilterStatus(status),
    [setFilterStatus]
  );
