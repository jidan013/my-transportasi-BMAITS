...
const VEHICLES: Vehicle[] = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?auto=format&fit=crop&w=600",
    year: 2023,
    capacity: "7 Penumpang",
  },
  {
    ...
    status: "maintenance",
    image:
      "https://images.unsplash.com/photo-1507136566006-8bb97875d4e5?auto=format&fit=crop&w=600",
    year: 2019,
    capacity: "5 Penumpang",
  },
];
...
function StatusBadge({
  ...
  borrower,
  returnDate,
}: Pick<Vehicle, "status" | "borrower" | "returnDate">) {
  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2 flex-wrap">
        <span
          className={`inline-flex items-center gap-1.5 px-3 py-1.5 ${color} border rounded-full font-semibold text-xs`}
          role="status"
        ...
        {isDueToday && (
          <span
            className="inline-flex items-center gap-1 px-2.5 py-1.5 bg-red-100 dark:bg-red-900/40 text-red-800 dark:text-red-300 border border-red-300 dark:border-red-700 rounded-full text-xs font-bold animate-pulse"
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-3">
        <div
          className={`p-3 rounded-xl ${bg} group-hover:scale-105 transition-transform duration-300`}
        >
    ...
    >
      ...
      <div className="flex-1">
        <p className="text-sm font-semibold text-gray-900 dark:text-white">
          {user}{" "}
          <span className="text-[#002D72] dark:text-[#00AEEF]">{action}</span>{" "}
          {vehicle}
        </p>
  ...
  return (
    ...
    >
      <div className="relative h-48 overflow-hidden">
        ...
        />
        <div
          className="absolute top-4 right-4 w-3 h-3 rounded-full bg-emerald-500 animate-pulse shadow-lg"
          aria-hidden="true"
        />
      </div>
      <div className="p-5">
...
export default function PageUser() {
  ...
  const stats = useMemo(() => {
    ...
    return {
      ...
      dueToday: VEHICLES.filter(
        (v) => v.status === "borrowed" && v.returnDate === today
      ).length,
    };
  }, []);
  ...
  const handleFilter = useCallback(
    (status: Status | null) => setFilterStatus(status),
    []
  );
      ...
      >
          ...
          <div className="relative z-10 max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-base sm:text-lg md:text-xl text-white/80 max-w-3xl mx-auto font-light mb-8">
                Platform modern untuk pengelolaan armada institusi dengan
                efisiensi, transparansi, dan kemudahan.
              </p>
            </motion.div>
                ...
                whileHover={
                  !reduced
                    ? {
                        scale: 1.05,
                        y: -4,
                        boxShadow: "0 15px 30px rgba(0,45,114,0.4)",
                      }
                    : {}
                }
                whileTap={{ scale: 0.95 }}
        ...
        <section className="py-16 px-4 sm:px-6 bg-gradient-to-b from-transparent to-gray-50 dark:to-gray-900">
          <div className="max-w-7xl mx-auto">
            ...
            >
              <IconTrendingUp
                className="w-8 h-8 text-[#002D72] dark:text-[#00AEEF]"
                aria-hidden="true"
              />
              Statistik Cepat
            </motion.h2>
              ...
              <AnimatePresence mode="popLayout">
                {isLoading
                  ? Array.from({ length: 3 }).map((_, i) => (
                      <SkeletonCard key={`${uid}-skeleton-${i}`} />
                    ))
                  : MAINTENANCE_SCHEDULES.map((m) => (
                      <MaintenanceCard key={m.id} {...m} />
                    ))}
              </AnimatePresence>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="space-y-4">
              <AnimatePresence mode="popLayout">
                {isLoading
                  ? Array.from({ length: 3 }).map((_, i) => (
                      <SkeletonCard key={`${uid}-activity-skeleton-${i}`} />
                    ))
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row gap-4 mb-8">
              ...
              <div className="flex gap-2 flex-wrap">
                {[
                  { label: "Semua", icon: IconCar, value: null as null },
                  {
                    label: "Tersedia",
                    icon: IconCircleCheckFilled,
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-xl font-semibold text-sm flex items-center gap-2 transition-all focus:outline-none focus:ring-2 focus:ring-[#002D72] ${
              ...
              <AnimatePresence mode="popLayout">
                {isLoading ? (
                  Array.from({ length: 6 }).map((_, i) => (
                    <SkeletonCard key={`${uid}-vehicle-skeleton-${i}`} />
                  ))
