...
const mockHistory: BorrowItem[] = [
  ...
  },
  {
    ...
    status: "pending",
    timeline: [
      { key: "diajukan", label: "Diajukan", time: "1 Nov 2025" },
    ],
  },
];
    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="relative mb-8">
        ...
        <input
          ...
          className="w-full pl-12 pr-4 py-3 rounded-2xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-200 focus:ring-2 focus:ring-[#00AEEF] focus:outline-none"
        />
      </div>
